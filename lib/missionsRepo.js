...
/**
 * Versão "ao vivo" de getTodasAsMissoes — escuta a coleção via onSnapshot em
 * vez de buscar uma vez, pro painel Admin (aba Conquistas, na hora de
 * escolher a missão vinculada) refletir mudanças na hora, sem
 * sair-e-voltar. Mesmo padrão de lib/conquistasRepo.js
 * (subscribeATodasAsConquistas). Retorna a função de cancelar a escuta.
 */
