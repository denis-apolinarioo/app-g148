...
/**
 * "Ontem" no fuso de Brasília, no mesmo formato YYYY-MM-DD — mesmo cálculo
 * que atualizarStreak (lib/points.js) já usa pra decidir se o streak
 * continua. Usado pra saber se a fogueira do streak ainda deve ficar acesa
 * (ver aceso em ProfileView.js): fica acesa se ultimoDiaAtivo foi hoje OU
 * ontem — só apaga de fato depois que passa 00:00 do 2º dia sem nada.
 */
export function yesterdayBrasilia() {
