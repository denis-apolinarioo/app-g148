...
export const CATEGORIAS_NOTIFICACAO = [
  ...
  { chave: 'mencao', label: 'Menções (@você)' },
  { chave: 'pontos', label: 'Ganho de pontos e dracmas' },
  { chave: 'conquista', label: 'Conquistas desbloqueadas' },
  { chave: 'missao_nova', label: 'Novas missões disponíveis' },
  { chave: 'correio_recompensa', label: 'Correio com recompensa' },
];
