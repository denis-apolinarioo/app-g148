...
export async function toggleLike(postId, uid, jaCurtiu) {
...
export async function addComment(postId, autor, texto) {
...
// ---------------------------------------------------------------------------
// CORREIO (mensagens do admin para membros específicos)
// ---------------------------------------------------------------------------

export async function sendMailMessage(remetenteId, destinatarioId, texto) {
