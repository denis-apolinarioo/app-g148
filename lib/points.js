...
import { getPontosEfetivosDeUmaMissao } from './missionOverrides';
...
/**
 * Pontos por postar espontaneamente no mural (fora do fluxo de missões).
 */
export async function pontuarPostMural(uid, postId) {
  await awardPoints(uid, PONTOS.postarNoMural, 'post', 'Post no Mural', postId);
}
