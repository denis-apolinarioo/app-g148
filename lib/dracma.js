...
export async function transferirDracma(origem, chaveDestino, valor, pin, descricao = '') {
  ...
  // RECEBEU: NÃO dá pra checar/conceder aqui (quem está rodando esta função
  // é quem ENVIOU, e a regra do Firestore só deixa cada pessoa criar a
  // PRÓPRIA conquista — achievementsUnlocked.uid == request.auth.uid).
  // Quem recebeu pega a conquista sozinho, na sessão dele, pelo contexto
  // 'sessao' (ver lib/achievements.js e components/AuthProvider.js).
