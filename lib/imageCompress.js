...
// Item 3 do Bloco A — versão bem menor, só pra aparecer nas LISTAS (Feed,
...
//
// AJUSTE DE QUALIDADE (feedback: thumbnail feia/baixa qualidade no Feed):
// os valores antigos (400px, qualidade 0.7, teto 150KB) ficavam pequenos
// demais pro espaço que a foto ocupa no cartão do post (PostCard.js exibe
// em w-full, podendo passar de 600-700px de largura em telas maiores), daí
// o navegador esticava uma imagem de 400px pra caber ali e borrava. Novos
// valores: 800px (dobro de resolução linear = 4x mais pixels) e qualidade
// 0.75 — em testes com fotos variadas isso ficou por volta de 50-70KB,
// nitidamente mais nítido mas ainda bem abaixo dos ~200-300KB da imagem em
// tamanho cheio (que não muda em nada — continua sendo a que abre ao tocar
// na foto). Teto de segurança (maxSizeMB) subiu de 0.15 pra 0.3 só pra dar
// folga em fotos mais "cheias de detalhe" (ex.: print de tela, foto com
// muito texto), sem forçar compressão extra nas fotos comuns, que já ficam
// bem abaixo disso.
const OPCOES_THUMB = {
  maxSizeMB: 0.3,
