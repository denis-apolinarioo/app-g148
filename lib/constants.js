...
export const ABAS_PRINCIPAIS = [
  ...
  // Ícone de arco e flecha (components/BowArrowIcon.js) no lugar da lista de
  // tarefas — combina mais com o tema de "Missões" do que o ícone genérico.
  { href: '/missoes', label: 'Missões', icone: 'bow-arrow' },
...
export const PONTOS = {
  ...
  // Pergaminho do versículo do dia (VersiculoDiario.js) — concedido só na
  // 1ª vez que a pessoa abre o versículo NO DIA (ver lib/points.js ->
  // pontuarAberturaVersiculo), pra não virar fonte infinita de pontos
  // abrindo/fechando várias vezes.
  abrirVersiculo: 3,
};
