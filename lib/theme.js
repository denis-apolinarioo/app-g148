...
function aplicarTema(tema) {
  ...
  // Passo 1: limpa o valor agora (força o navegador a registrar que ALGO
  // mudou nessa tag). Passo 2, no próximo frame: aplica a cor final. Duas
  // mudanças de `content` em vez de uma só ajuda o Chrome no Android a não
