 ...
 * mesma pasta do usuário, numa subpasta "thumbs" pra não misturar com os
 * arquivos em tamanho cheio. Se a compressão da thumbnail falhar por
...
async function uploadThumbnail(uid, arquivo, pastaBase) {
  ...
  const caminho = `${pastaBase}/${uid}/thumbs/${nomeArquivo}`;
