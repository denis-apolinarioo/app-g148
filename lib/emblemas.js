...
//
// `moldura` é a geometria de encaixe de cada PNG: a foto agora preenche o
// círculo TODO (100% do selo), e o anel/moldura entra por cima como um
// elemento maior que o próprio círculo, "por fora" dele (anel + louros
// ultrapassando a borda), em vez de ficar encolhido pra caber dentro. Os
// números vêm de medir o vão transparente real de cada PNG (não é o mesmo
// pra todos — o gabarito de 900x900 da esmeralda/rubi tem uma folha maior
// em volta do anel do que o de 400x400 dos demais):
...
export const EMBLEMAS = [
  {
    ...
    intensidade: 0.32,
    duracaoSeg: 5.6,
    moldura: { escala: '171.7%', deslocX: '-35.6%', deslocY: '-24.5%' },
  },
  {
    id: 'bronze',
    nome: 'Bronze',
  ...
  },
  {
    ...
    intensidade: 0.85,
    duracaoSeg: 2.8,
    moldura: { escala: '184.0%', deslocX: '-42.1%', deslocY: '-30.5%' },
  },
  {
    id: 'rubi',
    nome: 'Rubi',
    ...
    intensidade: 0.9,
    duracaoSeg: 2.5,
    moldura: { escala: '183.3%', deslocX: '-41.3%', deslocY: '-29.9%' },
  },
  {
    id: 'diamante',
    nome: 'Diamante',
