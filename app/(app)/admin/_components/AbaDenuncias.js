...
import { subscribeToReports, marcarDenunciaResolvida, subscribeToAllUsers } from '@/lib/firestore-helpers';
...
export default function AbaDenuncias() {
  ...
  // Ao vivo (onSnapshot) — se o nome/avatar de alguém mudar, ou se um novo
  // usuário virar autor de algo denunciado, aparece aqui sem recarregar.
  useEffect(() => {
    const unsub = subscribeToAllUsers((lista) => {
