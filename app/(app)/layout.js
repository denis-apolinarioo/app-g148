...
import { useSincronizarBarrinha, usePresetAtivo } from '@/lib/theme';
...
export default function AppLayout({ children }) {
  ...
  // Mantém a cor do app sincronizada com o Firestore enquanto a pessoa
  // está em qualquer tela logada (não só na aba Perfil, onde fica o
  // seletor) — se o Admin editar um preset ou trocar o padrão do app, quem
  // já está com o app aberto vê a cor mudar sozinha, sem precisar recarregar.
  usePresetAtivo();
