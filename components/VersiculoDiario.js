...
export default function VersiculoDiario({ uid, perfil }) {
  ...
  return (
    <div className="relative overflow-hidden rounded-xl2 bg-forte px-6 py-6 shadow-soft">
                  ...
                  <button
                    ...
                    className={`flex flex-shrink-0 flex-col items-center gap-1 rounded-xl2 px-3 py-2.5 transition-transform active:scale-95 ${
                      jaRecebidoHoje
                        ...
                        : 'bg-gold-soft/90 text-forte-900 shadow-md active:bg-gold-soft'
                    } disabled:opacity-70`}
                  >
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-forte">
