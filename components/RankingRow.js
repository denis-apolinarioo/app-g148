...
export default function RankingRow({ posicao, usuario, souEu }) {
  ...
  return (
    ...
    >
      <span className="flex w-7 flex-shrink-0 items-center justify-center font-display text-base font-medium text-coffee-400">
        {medalha || posicao}
      </span>
      ...
      <span className="flex-shrink-0 font-display text-base font-semibold text-coffee-700">
        {usuario.pontos || 0}
      </span>
    </Link>
  );
