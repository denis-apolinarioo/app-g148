      ...
      <div className="flex flex-col items-center text-center">
        ...
        {usuario.proposito && (
          <div className="relative mt-5 w-full overflow-hidden rounded-xl2 border border-coffee-200 bg-coffee-100 p-4 pl-5 text-left shadow-card">
            <span className="absolute inset-y-0 left-0 w-1.5 bg-gradient-to-b from-coffee-400 to-forte" />
  ...
  return (
    <button
      ...
      className={`flex flex-1 items-center justify-center border-b-2 pb-2.5 pt-2 transition-colors ${
        // A barrinha ativa e o ícone ativo agora usam o MESMO número da
        // escala (coffee-800) — antes eram números diferentes vindo de
        // listas de override separadas (border e texto), que coincidiam
        // por sorte no claro mas desencontravam no escuro, daí o remendo
        // com cor fixa que existia aqui. Com a paleta em variável CSS
        // (lib/theme.js), duas classes com o mesmo número SEMPRE batem,
        // em qualquer preset — o remendo não é mais necessário.
        ativo ? 'border-coffee-800 text-coffee-800' : 'border-transparent text-coffee-300'
      }`}
    >
