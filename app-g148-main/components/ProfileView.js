...
// vez de herdar cor via CSS. Cada um também tem uma variante "-dark"
// (mesmo desenho, recolorido pro mesmo tom claro que os ícones de verdade
// usam no modo escuro — ver lib/theme.js useTemaAtual), senão ficavam
// escuros em cima de fundo escuro e sumiam de vista.
function IconePosts({ size, ativo }) {
  const tema = useTemaAtual();
  const sufixo = tema === 'escuro' ? '-dark' : '';
  return (
    <img
      src={ativo ? `/icons/custom/post-active${sufixo}.png` : `/icons/custom/post-inactive${sufixo}.png`}
      width={size}
      height={size}
      alt=""
...
function IconeOracoesPerfil({ size, ativo }) {
  ...
  return (
    <img
      src={ativo ? `/icons/custom/hands-active-perfil${sufixo}.png` : `/icons/custom/hands-inactive${sufixo}.png`}
      width={size}
      height={size}
      alt=""
      className="object-contain"
...
function IconeConquistas({ size, ativo }) {
  ...
  return (
    <img
      src={ativo ? `/icons/custom/medal-active${sufixo}.png` : `/icons/custom/medal-inactive${sufixo}.png`}
      width={size}
      height={size}
      alt=""
      className="object-contain"
